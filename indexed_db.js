...
function getDatas(key, value, onsuccess, onerror) {
...
function getAllDatas(onsuccess, onerror) {
...
function updateData(key, oldValue, newValue, onsuccess, onerror) {
...
function deleteData(key, value, onsuccess, onerror) {
